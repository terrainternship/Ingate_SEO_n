15-22ноября
-------------------------------------------------------------------------------------
 С точки зрения клиента на seo продвижения у ингейта сервиса https://rookee.ru/
их сервис должен проанализировать страницу моего сайта по щелчку и на основании её содержимого
подобрать релевантные коммерческие запросы для продвижения (для последующей закупки ссылок содержащие эти запросы на других авторитетных сайтах)
Для понимания какой запрос коммерческий сейчас этот запрос помещается в поиск яндекс и проверяется на наличие сайтов, но возможны ошибки как рекламная выдача директ или сайты типа wikipedia будут присутсвовать в выдаче.
...
получаем url под запросы далее проходим по этим url и сравниваем с паттерном каждый сайт в выдаче  топ 10,  если большая доля коммерческих, то ставим запросу метку коммерческий и он подходит для сайта.
задача под спарсенную страницу пользовательского сайта подобрать запросы продвижения с разбивкой коммерческий некоммерческий и потом их кластеризовать.
